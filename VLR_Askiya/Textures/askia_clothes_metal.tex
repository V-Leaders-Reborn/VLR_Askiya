...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\askia_clothes_metal.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4081264993</m_ExportedTime>
	<m_ClassName text="Leader_Metalness"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="askia_clothes_metal.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="askia_clothes_metal"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
